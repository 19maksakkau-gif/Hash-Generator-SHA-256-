...
fn hash_file(filename: &str) -> Result<String, io::Error> {
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("\x1b[36m🔐 Hash Generator (SHA-256) (Rust)\x1b[0m");
    println!("Алгоритм: SHA-256");
