...
public class hash_generator {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\u001B[36m🔐 Hash Generator (SHA-256) (Java)\u001B[0m");
        System.out.println("Алгоритм: SHA-256");
        ...
        if (filePath != null) {
            ...
            hexDigest = computeHash(input.getBytes());
        } else {
            // stdin
            ...
            hexDigest = computeHash(data.getBytes());
        }
    ...
    private static String hashFile(String filename) throws Exception {
        MessageDigest md = MessageDigest.getInstance("SHA-256");
